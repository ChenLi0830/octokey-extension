(function () {
  ...
  if (!location.ancestorOrigins.contains(extensionOrigin)) {
    ...
    //iframe.style.background = "url("+chrome.extension.getURL('images/loader.gif')+") no-repeat
    // center center;"; iframe.style.background = "url(images/loader.gif') no-repeat center
    // center;";
